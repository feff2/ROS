...
static const _FullNameSumService_Request_type_support_symbol_names_t _FullNameSumService_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, full_name_messages, srv, FullNameSumService_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, full_name_messages, srv, FullNameSumService_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, full_name_messages, srv, FullNameSumService_Request)() {
  return &::full_name_messages::srv::rosidl_typesupport_c::FullNameSumService_Request_message_type_support_handle;
}
...
static const _FullNameSumService_Response_type_support_symbol_names_t _FullNameSumService_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, full_name_messages, srv, FullNameSumService_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, full_name_messages, srv, FullNameSumService_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, full_name_messages, srv, FullNameSumService_Response)() {
  return &::full_name_messages::srv::rosidl_typesupport_c::FullNameSumService_Response_message_type_support_handle;
}
...
static const _FullNameSumService_type_support_symbol_names_t _FullNameSumService_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, full_name_messages, srv, FullNameSumService)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, full_name_messages, srv, FullNameSumService)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, full_name_messages, srv, FullNameSumService)() {
  return &::full_name_messages::srv::rosidl_typesupport_c::FullNameSumService_service_type_support_handle;
}
