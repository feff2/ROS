...
class Metaclass_FullNameSumService_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('full_name_messages')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_FullNameSumService(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'full_name_messages.srv.FullNameSumService')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from full_name_messages.srv import _full_name_sum_service
...
class FullNameSumService(metaclass=Metaclass_FullNameSumService):
    from full_name_messages.srv._full_name_sum_service import FullNameSumService_Request as Request
    from full_name_messages.srv._full_name_sum_service import FullNameSumService_Response as Response
