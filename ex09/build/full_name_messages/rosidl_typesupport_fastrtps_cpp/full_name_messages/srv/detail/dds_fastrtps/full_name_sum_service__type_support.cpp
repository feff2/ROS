...
#include "full_name_messages/srv/detail/full_name_sum_service__rosidl_typesupport_fastrtps_cpp.hpp"
...
bool
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_full_name_messages
cdr_serialize(
  const full_name_messages::srv::FullNameSumService_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  full_name_messages::srv::FullNameSumService_Request & ros_message)
{
  // Member: last_name
  cdr >> ros_message.last_name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = full_name_messages::srv::FullNameSumService_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const full_name_messages::srv::FullNameSumService_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<full_name_messages::srv::FullNameSumService_Request *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_full_name_messages
const rosidl_message_type_support_t *
get_message_type_support_handle<full_name_messages::srv::FullNameSumService_Request>()
{
  return &full_name_messages::srv::typesupport_fastrtps_cpp::_FullNameSumService_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, full_name_messages, srv, FullNameSumService_Request)() {
  return &full_name_messages::srv::typesupport_fastrtps_cpp::_FullNameSumService_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_full_name_messages
cdr_serialize(
  const full_name_messages::srv::FullNameSumService_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: full_name
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  full_name_messages::srv::FullNameSumService_Response & ros_message)
{
  // Member: full_name
  cdr >> ros_message.full_name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = full_name_messages::srv::FullNameSumService_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const full_name_messages::srv::FullNameSumService_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<full_name_messages::srv::FullNameSumService_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &full_name_messages::srv::typesupport_fastrtps_cpp::_FullNameSumService_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, full_name_messages, srv, FullNameSumService_Response)() {
  return &full_name_messages::srv::typesupport_fastrtps_cpp::_FullNameSumService_Response__handle;
}
...
{
  return &full_name_messages::srv::typesupport_fastrtps_cpp::_FullNameSumService__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, full_name_messages, srv, FullNameSumService)() {
  return &full_name_messages::srv::typesupport_fastrtps_cpp::_FullNameSumService__handle;
}
